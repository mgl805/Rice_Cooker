 ...
 */
public class ReheatController extends AnchorPane implements Runnable, Initializable {
	...
	*/
    public ReheatController() {}

   /**
    * Start/Restart background service to update the center menu 
    * when the button reheat is cliked
    */
    public void run() {}
    
    /**
     * Initializes the reheat controller class
     * This method is automatically called
     * after the fxml file has been loaded
     */
    @FXML
    private void initialize() {
    	log.info("initialization of Reheat Controller class");
	}
	...
	/**
	 * Called when the user clicks on the reheat button
	 */
	@SuppressWarnings("unused")
	@FXML
	private void handleButtonActionReheatCliked(ActionEvent event) {
