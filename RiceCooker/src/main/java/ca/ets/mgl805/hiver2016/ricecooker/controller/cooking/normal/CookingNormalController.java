 ...
 */
public class CookingNormalController extends AnchorPane implements Runnable, Initializable {
	...
	*/
    public CookingNormalController() {}

   /**
    * Start/Restart background service to update the center menu 
    * when the button cooking normal is cliked
    */
    public void run() {}
    
    /**
     * Initializes the cooking normal controller class
     * This method is automatically called
     * after the fxml file has been loaded
     */
    @FXML
    private void initialize() {
    	log.info("initialization of Cooking Normal Controller class");
	}
	...
	/**
	 * Called when the user clicks on the cooking normal button
	 */
	@SuppressWarnings("unused")
	@FXML
	private void handleButtonActionCookingNormalCliked(ActionEvent event) {
