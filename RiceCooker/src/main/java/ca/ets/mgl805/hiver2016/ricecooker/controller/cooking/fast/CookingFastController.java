 ...
 */
public class CookingFastController extends AnchorPane implements Runnable, Initializable {
	...
	*/
    public CookingFastController() {}

   /**
    * Start/Restart background service to update the center menu 
    * when the button cooking fast is cliked
    */
    public void run() {}
    
    /**
     * Initializes the cooking fast controller class
     * This method is automatically called
     * after the fxml file has been loaded
     */
    @FXML
    private void initialize() {
    	log.info("initialization of Cooking Fast Controller class");
	}
	...
	/**
	 * Called when the user clicks on the cooking fast button
	 */
	@SuppressWarnings("unused")
	@FXML
	private void handleButtonActionCookingFastCliked(ActionEvent event) {
