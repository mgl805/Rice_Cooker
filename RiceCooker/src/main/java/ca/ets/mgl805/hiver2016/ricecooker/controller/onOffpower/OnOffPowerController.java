package ca.ets.mgl805.hiver2016.ricecooker.controller.onOffpower;
...
/**
 * @OnOffPowerController - a simple on/off power controller class
 * <a href="mailto:asylvose@yahoo.fr">Sylvose ALLOGO</a>
 * @version $Revision: 1.1 $
 * @since 14 February 2016 09:00:00
 */
public class OnOffPowerController extends AnchorPane implements Runnable, Initializable {
	
    private static final Logger log = LoggerFactory.getLogger(OnOffPowerController.class);
	...
	*/
    public OnOffPowerController() {}

   /**
    * Start/Restart background service to update the center menu 
    * when the button on/off power is cliked
    */
    public void run() {}
    
    /**
     * Initializes the on/off power controller class
     * This method is automatically called
     * after the fxml file has been loaded
     */
    @FXML
    private void initialize() {
    	log.info("initialization of On/Off Power Controller class");
	}
	...
	/**
	 * Called when the user clicks on the on/off power button
	 */
	@SuppressWarnings("unused")
	@FXML
	private void handleButtonActionOnOffPowerCliked(ActionEvent event) {
